...
class R2GenGPT(pl.LightningModule):
    ...
    def __init__(self, args):
        ...
        self.image_save_path = args.image_save_path if args.image_save_path else './saved_images'
    ...
    def test_step(self, samples, batch_idx):
        ...
        # 这里的图片保存部分
        for i, img in zip(range(3), samples["image"]):
            save_image(img, os.path.join(self.image_save_path, f"test_image_{batch_idx}_{i}.png"))
        ...
        with open(os.path.join(self.image_save_path, f"test_generated_{batch_idx}.json"), "w") as f:
            json.dump(hypo, f)
